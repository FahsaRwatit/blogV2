---
title: " Go基本语法——数据类型"
description: "基本语法——数据类型"
date: 2020-03-12 15:10:00
slug: demo_type
image:
categories:
    - Go
...
d := 1
dPtr := &d
fmt.Println(d, dPtr) // 1 0xc0000120a8
fmt.Printf("%T %T", d, dPtr) // int *int

// dPtr = dPtr + 1 //  invalid operation: dPtr + 1 (mismatched types *int and int)
fmt.Println()
// string 默认初始化为空字符串
var s string
fmt.Println("*" + s + "*") // **
